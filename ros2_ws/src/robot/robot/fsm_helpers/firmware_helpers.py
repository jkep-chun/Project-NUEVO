...
def start_robot(robot: Robot) -> None:
    ...
    robot.set_deadband(hm.Motor.DC_M1, hm.DB_STATIC, hm.DB_KINETIC, hm.STOP_THRESHOLD)
    robot.set_pid_gains(hm.Motor.DC_M2, hm.DCPidLoop.VELOCITY, kp, ki, kd)
    robot.set_deadband(hm.Motor.DC_M2, hm.DB_STATIC, hm.DB_KINETIC, hm.STOP_THRESHOLD)
